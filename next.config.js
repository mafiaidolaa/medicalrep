...
const nextConfig = {
  ...
  onDemandEntries: {
    // Keep pages warm longer in dev to reduce cold compiles
    maxInactiveAge: isDev ? 120 * 1000 : 60 * 1000,
    // Buffer more pages to avoid frequent rebuilds while navigating
    pagesBufferLength: 8,
  },
};
