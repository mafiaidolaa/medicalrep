...
// DELETE /api/accounting/collections/[id] - Soft delete collection (payment)
  ...
  try {
    ...
    try {
      ...
      await activityLogger.log({
        ...
        entity_id: id,
        title: `تحصيل إلى سلة المهملات: ${id}`,
        details: `تم نقل التحصيل إلى سلة المهملات بواسطة ${(session.user as any)?.email || 'unknown'}`,
        type: 'delete',
