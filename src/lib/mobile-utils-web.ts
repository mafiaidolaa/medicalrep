// Web-optimized mobile utilities (Capacitor-free)
// Lightweight utilities for mobile web experiences
...
// Always false since we removed Capacitor
...
// Web-based vibration (no Capacitor needed)
...
export function setupKeyboard(): void {
  // Web implementation for virtual keyboard handling
...
export async function initializeMobile(): Promise<void> {
  console.log('🚀 Initializing web-optimized mobile features...');
  ...
  try {
    ...
    console.log('✅ Web-optimized mobile features initialized');
